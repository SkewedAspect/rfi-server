...
class Entity extends events.EventEmitter
{
    ...
    /**
     * Controls how we generate our JSON representation. Returns a plain object with all the serialized properties of
     * our model.
     *
    ...
    toJSON()
    {
        return {
            id: this.id,
            behavior: this.model.behavior || this.template.behavior,
            state: this.state
        };
    } // end toJSON()
    /**
