...
RFIClient.prototype._handleSelectChar = function(payload, respond)
{
    ...
    models.Character.get(payload.character).getJoin().run()
        .then(function(character)
        {
            ...
            respond({
                confirm: true,
                zone: character.activeShip.zone    //TODO: Eventually we need to know if we should load the character, or the ship.
            });
 ...
 * @private
 */
RFIClient.prototype._handleConfigRequest = function (payload, respond)
{
    respond({
        confirm: true,
